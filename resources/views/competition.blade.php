...
@section('content')
    <div class="card mb-3">
        ...
        <div class="card-body position-relative">
            <div class="row">
                <div class="col-lg-8">
                    <h3>Competition Update</h3>
                    <p class="mb-0">Data competition update.</p>
                </div>
                <div class="col-lg-4">
        ...
        <div class="card-header">
            <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                    <h5 class="mb-0">Table competition</h5>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content position-relative">
                ...
                <div class="modal-body p-0">
                    <div class="rounded-top-lg py-3 ps-4 pe-6 bg-light">
                        <h4 class="mb-1" id="modalExampleDemoLabel">Form Competition</h4>
                    </div>
                    <div class="p-4 pb-0">
...
@section('script')
    <script>
        ...
        let tableLoad = $('#table').DataTable({
            ...
            serverSide:false,
            scrollX:true,
            ajax:"{{ config('constants.LINK_API') }}api/getCompetionUpdate",
            columns:[
            {
                data:'judul',
                name:'Judul'
        ...
        $('.btn-add').click(function () {
            link = 'competition/store';
            $('#form-competition')[0].reset();
        })

        $('#table').on('click','.btn-edit',function () {
            link = 'competition/update';
            $.ajax({
                type: "GET",
                url: "{{ config('constants.LINK_API') }}api/getCompetionUpdate/"+$(this).data('edit'),
                dataType: "JSON",
        ...
        $('#table').on('click','.btn-delete',function () {
            $.ajax({
                type: "DELETE",
                url: "{{ config('constants.LINK_API') }}api/delete/CompetionUpdate/"+$(this).data('delete'),
                dataType: "JSON",
                success: function (response) {
                    if(response.status === true){
                        ...
                        Swal.fire('Gagal','Gagal Delete Info Competition Update','error');
                    }
                }
            });
        })
        ...
        $('#form-competition').submit(function(e){
            e.preventDefault();
