...
@section('content')
    <div class="card mb-3">
        ...
        <div class="card-body position-relative">
            <div class="row">
                <div class="col-lg-8">
                    <h3>Informasi Kemdikbud</h3>
                    <p class="mb-0">Data informasi kemdikbud.</p>
                </div>
                <div class="col-lg-4">
        ...
        <div class="card-header">
            <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                    <h5 class="mb-0">Table Informasi</h5>
                </div>
            </div>
        </div>
...
@section('script')
    <script>
        ...
        let tableLoad = $('#table').DataTable({
            ...
            serverSide:false,
            scrollX:true,
            ajax:"{{ config('constants.LINK_API') }}api/getinfoKemdikbud",
            columns:[
            {
                data:'judul'
            },
        ...
        $('.btn-add').click(function () {
            link = 'info-kemdikbud/store';
            $('#form-kemdikbud')[0].reset();
        })

        $('#table').on('click','.btn-edit',function () {
            link = 'info-kemdikbud/update';
            $.ajax({
                type: "GET",
                url: "{{ config('constants.LINK_API') }}api/getinfoKemdikbud/"+$(this).data('edit'),
                dataType: "JSON",
        ...
        $('#table').on('click','.btn-delete',function () {
            $.ajax({
                type: "DELETE",
                url: "{{ config('constants.LINK_API') }}api/delete/infoKemdikbud/"+$(this).data('delete'),
                dataType: "JSON",
                success: function (response) {
                    if(response.status === true){
                        ...
                        Swal.fire('Gagal','Gagal Delete Info Kemdikbud Webina','error');
                    }
                }
            });
        })
        ...
        $('#form-kemdikbud').submit(function(e){
            e.preventDefault();
