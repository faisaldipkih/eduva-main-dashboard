        ...
        <div class="card-body position-relative">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <p class="mb-0">Data student exchanges.</p>
                </div>
                <div class="col-lg-4">
        ...
        <div class="card-header">
            <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                    <h5 class="mb-0">Table Student Exchanges</h5>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content position-relative">
                ...
                <div class="modal-body p-0">
                    <div class="rounded-top-lg py-3 ps-4 pe-6 bg-light">
                        <h4 class="mb-1" id="modalExampleDemoLabel">Form Student Exchanges</h4>
                    </div>
                    <div class="p-4 pb-0">
...
@section('script')
    <script>
        ...
        let tableLoad = $('#table').DataTable({
            ...
            serverSide:false,
            scrollX:true,
            ajax:"{{ config('constants.LINK_API') }}api/getinfoStudentExchanges",
            columns:[
            {
                data:'judul'
            },
        ...
        $('.btn-add').click(function () {
            link = 'student-ex/store';
            $('#form-student')[0].reset();
        })

        $('#table').on('click','.btn-edit',function () {
            link = 'student-ex/update';
            $.ajax({
                type: "GET",
                url: "{{ config('constants.LINK_API') }}api/getinfoStudentExchanges/"+$(this).data('edit'),
                dataType: "JSON",
        ...
        $('#table').on('click','.btn-delete',function () {
            $.ajax({
                type: "DELETE",
                url: "{{ config('constants.LINK_API') }}api/delete/infoStudentExchanges/"+$(this).data('delete'),
                dataType: "JSON",
                success: function (response) {
                    if(response.status === true){
                        ...
                        Swal.fire('Gagal','Gagal Delete Student Exchanges','error');
                    }
                }
            });
        })
