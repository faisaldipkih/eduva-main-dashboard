        ...
        <div class="card-header">
            <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                    <h5 class="mb-0">Table User</h5>
                </div>
            </div>
        </div>
        <div class="card-body pt-0">
            {{-- <div class="table-responsive"> --}}
                <table id="table-user" class="table table-sm table-bordered table-striped mb-0 fs--1 w-100">
                    <thead class="bg-200">
                        <tr>
                            <th>Username</th>
                            <th>Email</th>
...
@section('script')
    <script>
        let tableLoad = $('#table-user').DataTable({
            ordering:false,
            serverSide:false,
            scrollX:true,
            ajax:"https://api.skuva.id/api/getAllUser",
            columns:[{
                data:'username'
            },
            {
