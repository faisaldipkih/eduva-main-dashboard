        ...
        <div class="card-body position-relative">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <p class="mb-0">Informasi training program.</p>
                </div>
                <div class="col-lg-4">
        ...
        <div class="card-header">
            <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                    <h5 class="mb-0">Table Info Training</h5>
                </div>
            </div>
        </div>
...
@section('script')
    <script>
        ...
        let tableLoad = $('#table').DataTable({
            ...
            serverSide:false,
            scrollX:true,
            ajax:"{{ config('constants.LINK_API') }}api/getinfoTrainingProgram",
            columns:[
            {
                data:'judul'
            },
        ...
        $('.btn-add').click(function () {
            link = 'info-training/store';
            $('#form-training')[0].reset();
        })

        $('#table').on('click','.btn-edit',function () {
            link = 'info-training/update';
            $.ajax({
                type: "GET",
                url: "{{ config('constants.LINK_API') }}api/getinfoTrainingProgram/"+$(this).data('edit'),
                dataType: "JSON",
        ...
        $('#table').on('click','.btn-delete',function () {
            $.ajax({
                type: "DELETE",
                url: "{{ config('constants.LINK_API') }}api/delete/infoTrainingProgram/"+$(this).data('delete'),
                dataType: "JSON",
                success: function (response) {
